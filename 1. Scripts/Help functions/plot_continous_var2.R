...
#' @export
# Eg. different sources in each lake, and the question is how arctic charr pelagic reliance is changing along some environmental variable
plot_continuous_var2 <- function(jags.1, mix, source, output_options, alphaCI=0.05, exclude_sources_below=0.1){
