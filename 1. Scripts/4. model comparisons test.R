...
jags.objects<-c("mixSIAR_model_Mod with lake+species+PC1 w_0.23.rds",
                "mixSIAR_model_Mod with lake+species+For_area w_0.23.rds",
                "mixSIAR_model_Mod with lake+species+POM_NC_ratio w_0.23.rds")
...
names(model_list)<-c("1|Lake+species+PC1",
                     "1|Lake+species+for",
                     "1|Lake+species+POM_NC_ratio")
...
## In our case this higher ILR scores indicate higher aquatic dietary proportion in consumers
