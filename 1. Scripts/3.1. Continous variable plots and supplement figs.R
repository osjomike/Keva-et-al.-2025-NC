...
#Folders<-c("epi.long_Mod with lake+species_rand+PC1 w_0.23_randSlope",
#           "bacw17.long_Mod with lake+species_rand+PC1 w_0.23_randSlope")
...
### END OF THE SCRIPT ###
#########################
quantile(jags[["BUGSoutput"]][["sims.list"]][["ilr.global"]], probs=c(0.025, 0.5, 0.975))
quantile(jags[["BUGSoutput"]][["sims.list"]][["ilr.global"]], probs=c(0.025, 0.5, 0.975))
test_data<-matrix(c(0.9580353, 0.8765839, 0.6737392,
                    0.0419647, 0.1234161, 0.3262608), ncol = 2)
